...
string inputPath = "D:\\横向项目\\运动检测\\A1_A1_20210715162846_20210715162915.avi";
string outputPath = "D:\\横向项目\\运动检测\\A1_A1_20210715162846_20210715162915_out.mp4";
...
void videoOutput(Ptr<IFrameSource> stabFrames, string outputPath)
{
	...
	while (!(stabFrame = stabFrames->nextFrame()).empty())
	{
		...
		{
			if (!writer.isOpened())
				writer.open(outputPath, VideoWriter::fourcc('H', '2', '6', '4'),
